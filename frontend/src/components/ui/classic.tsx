      ...
      >
        <defs>
          <clipPath id={clipMainId}>
            <path
              ...
              className="motion-safe:transition-[d,translate] motion-safe:duration-(--toggles-dot-dev--duration) motion-safe:dark:delay-[calc(var(--toggles-dot-dev--duration)*0.15)] dark:[d:path('M0_2h13a1_1_0_0010_10v14H0Z')] dark:not-supports-[d:path('M0_0')]:-translate-x-3.25 dark:not-supports-[d:path('M0_0')]:translate-y-0.5"
            />
          </clipPath>
        </defs>
        <g stroke={"currentColor"} strokeLinecap={"round"}>
          ...
          <path
            ...
            className="[transform-box:view-box] [transform-origin:center] motion-safe:[transition:transform_var(--toggles-dot-dev--duration),opacity_var(--toggles-dot-dev--duration)] motion-safe:delay-[calc(var(--toggles-dot-dev--duration)*0.15)] motion-safe:dark:delay-0 dark:[transform:scale(0)] dark:opacity-0"
          />
          <path
            d={"m20.3 3.7-2.5 2.5"}
            fill={"none"}
